...
function settime() {
    ...
    if (wakeupValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./images/morning.jpg)";
    ...
    if (lunchValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./images/lunch.jpg)";
        document.querySelector('.good-wish-text').innerText = "GOOD AFTERNOON!! FOOD TIME";
    }
    if (napValue == hours) {
        document.querySelector('#msg-text').innerHTML = "GET SOME TEA...IT'S JUST EVENING!";
        document.querySelector('#msg-img').style.background = "url(./images/nap.png)";
    ...
    if (nightValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./images/night.jpg)";
